...
<body>
	<div class="container-fluid">
		<br/><br/>		
		<a data-toggle="modal" href="#modalMain" class="btn btn-primary">Launch modal</a>
		
		<div class="modal" id="modalMain" data-backdrop="static">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<br/>
						<br/>
						<a data-toggle="modal" href="#modalSub" class="btn btn-primary">Launch modal</a>
					</div>
		...
		<div class="modal" id="modalSub" data-backdrop="static">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
						<h4 class="modal-title">Modal Sub</h4>
