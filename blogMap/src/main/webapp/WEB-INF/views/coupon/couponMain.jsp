...
// 		$.ajax({
// 			type:'get',
// 			url:'${root}/coupon/couponDetailInfo.do?coupon_no='+couponNo,
// 			contentType:'application/x-www-form-urlencoded;charset=UTF-8',
// 			 success:function(responseData){
// 				var data=JSON.parse(responseData);
// 				//var filename=data.partner_pic_name
...
// 				$("#couponDetailInfoResult").append($("#couponDetailInfoMain").clone().css("display","block"));
// 				$("#couponDetailInfoMain:last-child #coupon_info_img").attr("src", "${root}/pds/coupon/"+data[0].COUPON_PIC_NAME);
// 				$("#couponDetailInfoMain:last-child #partner_info_no").html(data[0].PARTNER_NAME);
// 				$("#couponDetailInfoMain:last-child #coupon_info_item").html(data[0].COUPON_ITEM);
// 				$("#couponDetailInfoMain:last-child #coupon_info_discount").html(data[0].COUPON_DISCOUNT);
// 				$("#couponDetailInfoMain:last-child #coupon_info_bymd").html(bymd);
// 				$("#couponDetailInfoMain:last-child #coupon_info_eymd").html(eymd);					
				
// // 				if(data[0].COUPON_YN == "Y"){
// // 					//$("#partner_submit").css("display", "none");
// // 					$("#couponDetailInfoMain:last-child #coupon_detail_button").attr({"name":data[0].COUPON_NO, "value":"취소"});
// // 				}else if(data[0].COUPON_YN == "N"){
// // 					//$("#partner_delete").css("display", "none");
// // 					$("#couponDetailInfoMain:last-child #coupon_detail_button").attr({"name":data[0].COUPON_NO, "value":"승인"});
// // 				} 
