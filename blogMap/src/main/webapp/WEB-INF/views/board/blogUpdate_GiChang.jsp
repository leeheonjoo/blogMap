...
<form class="form-horizontal" name="blogWriteForm" action="${root }/board/blogWrite" method="POST" id="frm" enctype="multipart/form-data">		<!-- 전체적인 폼 내에서 Label / Text 창의 크기를 조절하기 위해 필요한 폼 -->
		...
		<div class="col-md-12 col-sm-12 col-xs-12">		<!-- Div 를 3화면에서 12 칸 모두 사용 -->
			...
			<div class="form-group form-group-sm"  id="blogUpdateattach">		
				...
				<div class="col-md-2 col-sm-2 col-xs-2" style="display:none;" id="blogUp0">
					<span class="spanStyle">
					<input id="imgInp0" class="form-control" type="file" name="file" onchange="readURLS(this);" style="position: absolute; margin-left: 10px; width: 62px;height: 120px;filter:alpha(opacity=0); opacity:0; -moz-opacity:0; cursor: pointer;"/>
				...
				<div class="col-md-2 col-sm-2 col-xs-2" style="display:none;" id="blogUp1">
					<span class="spanStyle">
					<input id="imgInp1" class="form-control" type="file" name="file" onchange="readURLS(this);" style="position: absolute; margin-left: 10px; width: 62px;height: 120px;filter:alpha(opacity=0); opacity:0; -moz-opacity:0; cursor: pointer;"/>
				...
				<div class="col-md-2 col-sm-2 col-xs-2" style="display:none;" id="blogUp2">	
					<span class="spanStyle">
					<input id="imgInp2" class="form-control" type="file" name="file" onchange="readURLS(this);" style="position: absolute; margin-left: 10px; width: 62px;height: 120px;filter:alpha(opacity=0); opacity:0; -moz-opacity:0; cursor: pointer;"/>
				...
				<div class="col-md-2 col-sm-2 col-xs-2" style="display:none;" id="blogUp3">	
					<span class="spanStyle">
					<input id="imgInp3" class="form-control" type="file" name="file" onchange="readURLS(this);" style="position: absolute; margin-left: 10px; width: 62px;height: 120px;filter:alpha(opacity=0); opacity:0; -moz-opacity:0; cursor: pointer;"/>
				...
				<div class="col-md-2 col-sm-2 col-xs-2" style="display:none;" id="blogUp4">	
					<span class="spanStyle">
					<input id="imgInp4" class="form-control" type="file" name="file" onchange="readURLS(this);" style="position: absolute; margin-left: 10px; width: 62px;height: 120px;filter:alpha(opacity=0); opacity:0; -moz-opacity:0; cursor: pointer;"/>
